        ...
        {isArmed && !hasLiveFeed ? (
          ...
          >
            ...
            <p className="min-w-0 flex-1">
              บริดจ์เปิดอยู่ — เสียงออกทาง<span className="font-semibold text-cyan">มิกเซอร์</span>{' '}
              หน้านี้ทำหน้าที่เป็น<span className="font-semibold text-ink">ต้นทาง</span> เหมือนแร็คหน้าเวที:
              ปั้นโทนและตั้งเกนให้ดีที่นี่ แล้วไปคุมระดับในมิกซ์ที่ fader ของ desk{' '}
              ปุ่มทุกปุ่มที่นี่ยังมีผลกับเสียงที่ได้ยิน เพราะช่องบนมิกเซอร์เล่นผ่านแร็คชุดเดียวกันนี้ —
              ที่นิ่งคือมิเตอร์กับ GR ของสายมอนิเตอร์หน้านี้ ซึ่งปิดไว้เพื่อไม่ให้เสียงเข้าห้องสองรอบ
            </p>
          </div>
        ) : null}
